...
declare_handler_item :     // Condition handler declaration 
       (T_CONTINUE | T_EXIT) T_HANDLER T_FOR (T_SQLEXCEPTION | T_SQLWARNING (T_COMMA T_NOT T_FOUND)? | T_NOT T_FOUND | ident) single_block_stmt
     ;
...
T_RANK                 : R A N K ;
T_ROW_NUMBER           : R O W '_' N U M B E R | R O W  N U M B E R  ;
T_STDEV                : S T D E V ;
